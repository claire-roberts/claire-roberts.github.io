...
Shipping traffic is another less obvious disruptor of *Sargassum* environments.  Cargo and tanker vessels are a common occurrence in the Gulf of Mexico and they have the potential to disrupt *Sargassum* communities in several ways; 1) physical disruption of moving through *Sargassum* mats, 2) pollutant (sewage, oil, chemicals) discharge and 3) disruptive noise generated by the ships (<a href="http://www.sargassoseacommission.org/storage/documents/Sargasso.Report.9.12.pdf" target="_blank"> Laffoley et al. 2011</a>). More research is needed to quantify the impacts of shipping vessels on *Sargassum* communities. 
