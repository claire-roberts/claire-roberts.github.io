...
URL <- "https://api.mapbox.com/styles/v1/clairegmfmc/cj5tocvqk4q0f2smx1t9j09uq/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoiY2xhaXJlZ21mbWMiLCJhIjoiY2o1dG83cW9lMGM5dTMzdDgzdHh2emVkbSJ9.uH9tkZq3rXb53lcCc7O-TA"
...
m<-leaflet() %>% 
  ...
  addTiles('http://server.arcgisonline.com/ArcGIS/rest/services/Reference/World_Boundaries_and_Places/Mapserver/tile/{z}/{y}/{x}',
           options = providerTileOptions(noWrap = TRUE)) %>%
   addTiles(URL,attribution = map_attr) %>% 
